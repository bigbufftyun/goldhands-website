	...
	<div class="col-2">
		<div class="card">
			...
			<ul class="nav flex-column">
				<li class="nav-item">
					<a class="nav-link active" href="dashboard.php?patientID=<?php echo $_SESSION['pID']; ?>">Dashboard</a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a class="nav-link" href="p-profile-settings.php?editPID=<?php echo $_SESSION['pID']; ?>">Profile Settings</a>
				</li>
				<li>
...
<?php } if(isset($_SESSION['accessLevel']) AND $_SESSION['accessLevel'] == 2) { ?>
	<div class="col-2">
				<div class="card">
					...
					<ul class="nav flex-column">
						<li class="nav-item">
							<a class="nav-link active" href="therapist-dashboard.php?therapistID=<?php echo $_SESSION['tID'];?>">Dashboard</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="app-details.php">Appointment Details</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="health-records.php?therapistID=<?php echo $_SESSION['tID'];?>">Health Records</a>
						</li>
						<li class="nav-item">
